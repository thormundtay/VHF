			...
			evaluate=\convidx as \convx using (\convidx * \datawidth + \startrectx),
				...
				\foreach \convidx [
					evaluate=\convidx as \convx using (\convidx * \datawidth + \startrectx),
						...
						\begin{scope}
							\coordinate (ac) at (\convx + \datawidth/2, \startrecty + \dataheight/2); % Anchor center

							\node (mult) [anchor=center, trapezium, trapezium angle=60, fill=gray!25, rotate=180] at (ac) {\phantom {\tiny o}};
							\node[anchor=center] at (ac) {$\scriptstyle b_\convidx$};
